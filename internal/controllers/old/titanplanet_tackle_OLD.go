...
// ====================================
// TitanPlanetTackleOLDController
// ====================================
type TitanPlanetTackleOLDController struct {
...
// Handle
// ====================================
func (c *TitanPlanetTackleOLDController) Handle(player *pb.Player, update tgbotapi.Update) {
	// Verifico se è impossibile inizializzare
	if !c.InitController(controllers.Controller{
		Player: player,
		Update: update,
		CurrentState: controllers.ControllerCurrentState{
			Controller: "route.titanplanet.tackle",
			Payload:    &c.Payload,
		},
		Configurations: controllers.ControllerConfigurations{
			ControllerBack: controllers.ControllerBack{
				To:        &controllers.MenuController{},
				FromStage: 0,
			},
		},
	}) {
...
// Validator
// ====================================
func (c *TitanPlanetTackleOLDController) Validator() (hasErrors bool) {
	return false
}
...
// Stage
// ====================================
func (c *TitanPlanetTackleOLDController) Stage() {
...
func (c *TitanPlanetTackleOLDController) Tackle() {
	var err error
	...
	if c.Update.Message != nil {
		...
		combactCard := helpers.Trans(c.Player.Language.Slug, "titanplanet.tackle.combat.card",
			...
			helpers.Trans(c.Player.Language.Slug, controllers.bodyParts[c.Payload.Selection]),
		)
...
// Event
// ====================================
func (c *TitanPlanetTackleOLDController) Event(text string, event *pb.TitanEvent, titan *pb.Titan) {
...
// Fight
// ====================================
func (c *TitanPlanetTackleOLDController) Fight(action string, titan *pb.Titan) {
	var err error
	var editMessage tgbotapi.EditMessageTextConfig
...
func (c *TitanPlanetTackleOLDController) Drop(titan *pb.Titan) {
	var err error
